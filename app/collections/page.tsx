  ...
  const collections = [
    {
      ...
      image: "/placeholder.svg?height=600&width=400&text=Autumn+fashion+collection+elegant+dresses",
      category: "Couture",
      price: "À partir de 150 000 Ar",
      description:
        "Une collection qui célèbre les couleurs chaudes de l'automne malgache avec des tissus traditionnels revisités.",
      pieces: 24,
    },
    {
      id: "2",
      ...
      image: "/placeholder.svg?height=600&width=400&text=Sustainable+luxury+fashion+eco+materials",
      category: "Durable",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=600&width=400&text=Urban+streetwear+modern+style",
      category: "Streetwear",
    ...
    },
    {
      ...
      designer: "Miora Rasoanaivo",
      image: "/placeholder.svg?height=600&width=400&text=Modern+heritage+traditional+contemporary",
      category: "Fusion",
    ...
    },
    {
      ...
      title: "Soie Sauvage",
      designer: "Hery Andriantsoa",
      image: "/placeholder.svg?height=600&width=400&text=Wild+silk+luxury+collection",
      category: "Couture",
    ...
    },
    {
      ...
      designer: "Lalaina Rakoto",
      image: "/placeholder.svg?height=600&width=400&text=New+wave+fashion+avant+garde",
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h1 className="text-6xl font-extralight tracking-[0.2em] mb-6 serif-font">Collections</h1>
