...
import { Palette, Heart, Settings, LogOut, Handshake, BookOpen, Briefcase } from "lucide-react" // Added Briefcase icon for services
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-extralight tracking-[0.2em] mb-6 serif-font">Mon Compte</h1>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mt-16">
              <Card className="bg-white text-center border-0 shadow-none hover:shadow-lg transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-light mb-4 serif-font tracking-wide">Gérer mes Collections</h3>
              ...
              <Card className="bg-white text-center border-0 shadow-none hover:shadow-lg transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-600 font-light leading-relaxed mb-6">
                    Gérez les services que vous proposez (stylisme, conseil, etc.).
                  </p>
                  <Button className="bg-black text-white hover:bg-gray-800 font-light tracking-[0.1em] uppercase">
                    Gérer les Services
                  </Button>
              ...
              <Card className="bg-white text-center border-0 shadow-none hover:shadow-lg transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-light mb-4 serif-font tracking-wide">Paramètres du Profil</h3>
                  <p className="text-gray-600 font-light leading-relaxed mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-12 mt-16">
              <Card className="bg-white text-center border-0 shadow-none hover:shadow-lg transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-light mb-4 serif-font tracking-wide">Mes Favoris</h3>
                  <p className="text-gray-600 font-light leading-relaxed mb-6">
                    Retrouvez toutes les collections et créations que vous avez aimées.
                  </p>
                  <Button className="bg-black text-white hover:bg-gray-800 font-light tracking-[0.1em] uppercase">
                    Voir mes Favoris
                  </Button>
              ...
              <Card className="bg-white text-center border-0 shadow-none hover:shadow-lg transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-light mb-4 serif-font tracking-wide">Paramètres du Compte</h3>
                  <p className="text-gray-600 font-light leading-relaxed mb-6">
